...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const roiRows = computed(() => roiData.value?.rows ?? []);
      ...
      if (unref(loading)) {
        ...
        if (unref(canApprove) && unref(rekapSales).length) {
          ...
          ssrRenderList(unref(leaderboard), (r, idx) => {
            ...
            if (idx === 0) {
              _push(`<span class="text-base" data-v-ad177d93>🥇</span>`);
            } else if (idx === 1) {
              _push(`<span class="text-base" data-v-ad177d93>🥈</span>`);
            } else if (idx === 2) {
              _push(`<span class="text-base" data-v-ad177d93>🥉</span>`);
        ...
        if (unref(canApprove) && unref(roiRows).length) {
          ...
          ssrRenderList(unref(roiRows), (r) => {
            ...
            if (r.roi_revenue !== null) {
              _push(`<div class="mt-2.5 pt-2.5 border-t border-navy-700/60 flex items-center justify-between text-xs" data-v-ad177d93><span class="text-gray-500" data-v-ad177d93>ROI Revenue</span><span class="${ssrRenderClass([roiColor(r).text, "font-bold"])}" data-v-ad177d93>${ssrInterpolate(r.roi_revenue)}×</span></div>`);
            } else {
              _push(`<!---->`);
            }
            _push(`</div>`);
...
//# sourceMappingURL=index-DONMKq58.js.map
