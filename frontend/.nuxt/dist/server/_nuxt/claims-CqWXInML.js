  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(mapModal).open) {
        _push(`<div class="fixed inset-0 z-[60] flex items-center justify-center bg-black/70 backdrop-blur-sm p-4" data-v-60cc886a><div class="bg-apex-surface border border-apex-border rounded-2xl w-full max-w-xl shadow-2xl" data-v-60cc886a><div class="flex items-center justify-between p-4 border-b border-apex-border" data-v-60cc886a><div data-v-60cc886a><h2 class="text-base font-semibold text-apex-text" data-v-60cc886a><i class="fa-solid fa-map-location-dot text-primary-400 mr-2" data-v-60cc886a></i>Lokasi Klaim </h2><p class="text-xs text-apex-muted mt-0.5" data-v-60cc886a>${ssrInterpolate(unref(mapModal).claim?.nama_klien)} · ${ssrInterpolate(unref(fmt).tgl(unref(mapModal).claim?.tgl_klaim))}</p></div><button class="text-apex-muted hover:text-apex-text" data-v-60cc886a><i class="fa-solid fa-xmark text-xl" data-v-60cc886a></i></button></div><div class="p-4 space-y-3" data-v-60cc886a><div class="text-xs text-apex-muted" data-v-60cc886a>${ssrInterpolate(unref(mapModal).claim?.lokasi)} · <span class="font-mono" data-v-60cc886a>${ssrInterpolate(unref(mapModal).lat?.toFixed(6))}, ${ssrInterpolate(unref(mapModal).lng?.toFixed(6))}</span></div><div id="claims-map" class="w-full h-72 rounded-xl border border-apex-border overflow-hidden z-0" data-v-60cc886a></div><a${ssrRenderAttr("href", `https://www.google.com/maps?q=${unref(mapModal).lat},${unref(mapModal).lng}`)} target="_blank" class="flex items-center gap-2 text-xs text-primary-400 hover:text-primary-300" data-v-60cc886a><i class="fa-solid fa-arrow-up-right-from-square" data-v-60cc886a></i>Buka di Google Maps </a></div></div></div>`);
      } else {
        _push(`<!---->`);
      }
      if (unref(photoModal).open) {
        _push(`<div class="fixed inset-0 z-[70] flex flex-col items-center justify-center bg-black/85 backdrop-blur-sm p-4" data-v-60cc886a><div class="w-full max-w-2xl" data-v-60cc886a><div class="flex items-center justify-between mb-3 px-1" data-v-60cc886a><div data-v-60cc886a><div class="font-mono text-xs text-primary-400" data-v-60cc886a>${ssrInterpolate(unref(photoModal).claim?.claim_no)}</div><div class="text-sm font-medium text-white" data-v-60cc886a>${ssrInterpolate(unref(photoModal).claim?.nama_klien)}</div><div class="text-xs text-gray-400" data-v-60cc886a>${ssrInterpolate(unref(fmt).tgl(unref(photoModal).claim?.tgl_klaim))} · ${ssrInterpolate(unref(photoModal).claim?.sales_nama)}</div></div><button class="w-9 h-9 rounded-full bg-white/10 hover:bg-white/20 flex items-center justify-center transition-colors" data-v-60cc886a><i class="fa-solid fa-xmark text-white" data-v-60cc886a></i></button></div><img${ssrRenderAttr("src", `http://localhost:8001/storage/${unref(photoModal).claim?.foto_bukti}`)} class="w-full max-h-[70vh] object-contain rounded-xl shadow-2xl" data-v-60cc886a><div class="flex justify-center mt-3" data-v-60cc886a><a${ssrRenderAttr("href", `http://localhost:8001/storage/${unref(photoModal).claim?.foto_bukti}`)} target="_blank" class="flex items-center gap-2 text-xs text-gray-400 hover:text-white transition-colors" data-v-60cc886a><i class="fa-solid fa-arrow-up-right-from-square" data-v-60cc886a></i>Buka di tab baru </a></div></div></div>`);
      } else {
        _push(`<!---->`);
      }
...
//# sourceMappingURL=claims-CqWXInML.js.map
