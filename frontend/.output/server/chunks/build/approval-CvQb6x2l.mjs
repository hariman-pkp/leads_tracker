  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(detailModal).open) {
        ...
        if (((_b = unref(detailModal).claim) == null ? void 0 : _b.status) === "Pending") {
          _push(`<button class="btn-primary" data-v-6bd9ad54><i class="fa-solid fa-check mr-1" data-v-6bd9ad54></i>Approve </button>`);
        } else {
          _push(`<!---->`);
        }
        if (((_c = unref(detailModal).claim) == null ? void 0 : _c.status) === "Pending") {
      ...
      if (unref(mapModal).open) {
        _push(`<div class="fixed inset-0 z-[60] flex items-center justify-center bg-black/70 backdrop-blur-sm p-4" data-v-6bd9ad54><div class="bg-apex-surface border border-apex-border rounded-2xl w-full max-w-xl shadow-2xl" data-v-6bd9ad54><div class="flex items-center justify-between p-4 border-b border-apex-border" data-v-6bd9ad54><div data-v-6bd9ad54><h2 class="text-base font-semibold text-apex-text" data-v-6bd9ad54><i class="fa-solid fa-map-location-dot text-primary-400 mr-2" data-v-6bd9ad54></i>Lokasi Klaim </h2><p class="text-xs text-apex-muted mt-0.5" data-v-6bd9ad54>${ssrInterpolate((_h = unref(mapModal).claim) == null ? void 0 : _h.nama_klien)} \xB7 ${ssrInterpolate(unref(fmt).tgl((_i = unref(mapModal).claim) == null ? void 0 : _i.tgl_klaim))}</p></div><button class="text-apex-muted hover:text-apex-text" data-v-6bd9ad54><i class="fa-solid fa-xmark text-xl" data-v-6bd9ad54></i></button></div><div class="p-4 space-y-3" data-v-6bd9ad54><div class="text-xs text-apex-muted" data-v-6bd9ad54>${ssrInterpolate((_j = unref(mapModal).claim) == null ? void 0 : _j.lokasi)} \xB7 <span class="font-mono" data-v-6bd9ad54>${ssrInterpolate((_k = unref(mapModal).lat) == null ? void 0 : _k.toFixed(6))}, ${ssrInterpolate((_l = unref(mapModal).lng) == null ? void 0 : _l.toFixed(6))}</span></div><div id="approval-map" class="w-full h-64 rounded-xl border border-apex-border overflow-hidden z-0" data-v-6bd9ad54></div><a${ssrRenderAttr("href", `https://www.google.com/maps?q=${unref(mapModal).lat},${unref(mapModal).lng}`)} target="_blank" class="flex items-center gap-2 text-xs text-primary-400 hover:text-primary-300" data-v-6bd9ad54><i class="fa-solid fa-arrow-up-right-from-square" data-v-6bd9ad54></i>Buka di Google Maps </a></div></div></div>`);
      } else {
        _push(`<!---->`);
      }
      if (unref(photoModal).open) {
        _push(`<div class="fixed inset-0 z-[70] flex flex-col items-center justify-center bg-black/85 backdrop-blur-sm p-4" data-v-6bd9ad54><div class="w-full max-w-2xl" data-v-6bd9ad54><div class="flex items-center justify-between mb-3 px-1" data-v-6bd9ad54><div data-v-6bd9ad54><div class="font-mono text-xs text-primary-400" data-v-6bd9ad54>${ssrInterpolate((_m = unref(photoModal).claim) == null ? void 0 : _m.claim_no)}</div><div class="text-sm font-medium text-white" data-v-6bd9ad54>${ssrInterpolate((_n = unref(photoModal).claim) == null ? void 0 : _n.nama_klien)}</div><div class="text-xs text-gray-400" data-v-6bd9ad54>${ssrInterpolate(unref(fmt).tgl((_o = unref(photoModal).claim) == null ? void 0 : _o.tgl_klaim))} \xB7 ${ssrInterpolate((_p = unref(photoModal).claim) == null ? void 0 : _p.sales_nama)}</div></div><button class="w-9 h-9 rounded-full bg-white/10 hover:bg-white/20 flex items-center justify-center transition-colors" data-v-6bd9ad54><i class="fa-solid fa-xmark text-white" data-v-6bd9ad54></i></button></div><img${ssrRenderAttr("src", `http://localhost:8001/storage/${(_q = unref(photoModal).claim) == null ? void 0 : _q.foto_bukti}`)} class="w-full max-h-[70vh] object-contain rounded-xl shadow-2xl" data-v-6bd9ad54><div class="flex justify-center mt-3" data-v-6bd9ad54><a${ssrRenderAttr("href", `http://localhost:8001/storage/${(_r = unref(photoModal).claim) == null ? void 0 : _r.foto_bukti}`)} target="_blank" class="flex items-center gap-2 text-xs text-gray-400 hover:text-white transition-colors" data-v-6bd9ad54><i class="fa-solid fa-arrow-up-right-from-square" data-v-6bd9ad54></i>Buka di tab baru </a></div></div></div>`);
      } else {
        _push(`<!---->`);
      }
      if (unref(toast).show) {
...
//# sourceMappingURL=approval-CvQb6x2l.mjs.map
