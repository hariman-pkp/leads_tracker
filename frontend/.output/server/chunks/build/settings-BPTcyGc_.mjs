...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    const tileLimit = computed(() => {
      var _a2;
      return (_a2 = TILE_LIMITS[form.map_tile]) != null ? _a2 : 0;
    });
    ...
    const currentUsage = computed(() => {
      var _a2;
      return (_a2 = usageData.value[currentMonthKey.value]) != null ? _a2 : 0;
    });
      ...
      if (unref(loading)) {
        ...
        ssrRenderList(tileComparison, (row) => {
          ...
          ssrRenderList(row.values, (val, i) => {
            var _a3;
            _push(`<td class="${ssrRenderClass([[val.color, unref(form).map_tile === mapTileOptions[i].key ? "bg-primary-900/10" : ""], "px-3 py-2 text-center"])}" data-v-f4225c6b><span data-v-f4225c6b>${(_a3 = val.text) != null ? _a3 : ""}</span></td>`);
          });
          _push(`<!--]--></tr>`);
        });
        ...
        if (unref(current).map_tile) {
          _push(`<span class="text-xs text-gray-500" data-v-f4225c6b> Aktif: <span class="text-gray-300" data-v-f4225c6b>${ssrInterpolate((_b = (_a2 = mapTileOptions.find((o) => o.key === unref(current).map_tile)) == null ? void 0 : _a2.label) != null ? _b : unref(current).map_tile)}</span></span>`);
        } else {
          _push(`<!---->`);
        }
...
//# sourceMappingURL=settings-BPTcyGc_.mjs.map
