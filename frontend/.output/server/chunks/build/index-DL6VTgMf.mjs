...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    const statusEntries = computed(
      () => {
        var _a;
        return Object.entries(((_a = data.value) == null ? void 0 : _a.by_status) || {});
      }
    );
    const criticalPage = ref(1);
    const criticalTotal = computed(() => {
      var _a, _b, _c;
      return (_c = (_b = (_a = data.value) == null ? void 0 : _a.critical) == null ? void 0 : _b.length) != null ? _c : 0;
    });
    const criticalPages = computed(() => Math.ceil(criticalTotal.value / criticalPerPage) || 1);
    const criticalSlice = computed(() => {
      var _a, _b;
      const all = (_b = (_a = data.value) == null ? void 0 : _a.critical) != null ? _b : [];
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(_attrs)}><div class="page-header"><div><h1 class="page-title"><i class="fa-solid fa-chart-bar text-primary-400 mr-2"></i>Revenue Dashboard</h1><p class="page-subtitle">Monitoring revenue ${ssrInterpolate((_a = unref(data)) == null ? void 0 : _a.cur_year)}</p></div><div class="flex gap-2 items-center">`);
      if ((_c = (_b = unref(data)) == null ? void 0 : _b.years) == null ? void 0 : _c.length) {
      ...
      if (unref(pending)) {
        ...
        _push(`<!--]--></div></div></div>`);
        if ((_d = unref(data).critical) == null ? void 0 : _d.length) {
...
//# sourceMappingURL=index-DL6VTgMf.mjs.map
