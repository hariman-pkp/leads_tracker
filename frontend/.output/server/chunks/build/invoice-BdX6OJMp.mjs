...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    const isAdmin = computed(() => {
      var _a;
      return ((_a = auth.user) == null ? void 0 : _a.role_id) === 1;
    });
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if ((_g = unref(data)) == null ? void 0 : _g.inv_summary) {
      ...
      if (unref(pending)) {
        ...
        ssrRenderList((_i = unref(data)) == null ? void 0 : _i.invoices, (inv) => {
        ...
        _push(`<!--]-->`);
        if (!((_k = (_j = unref(data)) == null ? void 0 : _j.invoices) == null ? void 0 : _k.length)) {
        ...
        _push(ssrRenderComponent(_component_AppPagination, {
          ...
          total: (_m = (_l = unref(data)) == null ? void 0 : _l.total) != null ? _m : 0,
          "total-pages": (_o = (_n = unref(data)) == null ? void 0 : _n.total_pages) != null ? _o : 1,
          "per-page-options": [10, 25, 50, 100]
        }, null, _parent));
        _push(`</div>`);
      }
      if (unref(payModal).show) {
        _push(`<div class="fixed inset-0 bg-black/70 z-50 flex items-center justify-center p-4"><div class="bg-navy-900 border border-navy-700 rounded-xl w-full max-w-sm shadow-2xl p-5"><h3 class="font-semibold text-white mb-1">Konfirmasi Pembayaran</h3><div class="mb-4 p-3 rounded-lg bg-navy-800 space-y-1"><div class="flex justify-between text-xs"><span class="text-gray-500">Invoice</span><span class="text-white">${ssrInterpolate(((_p = unref(payModal).inv) == null ? void 0 : _p.invoice_no) || "\u2014")}</span></div><div class="flex justify-between text-xs"><span class="text-gray-500">Client</span><span class="text-gray-200">${ssrInterpolate((_q = unref(payModal).inv) == null ? void 0 : _q.client)}</span></div><div class="flex justify-between text-xs"><span class="text-gray-500">Nominal Invoice</span><span class="text-gray-200">${ssrInterpolate(unref(fmt).rupiah((_r = unref(payModal).inv) == null ? void 0 : _r.invoice_amount))}</span></div><div class="flex justify-between text-xs"><span class="text-gray-500">Sudah Dibayar</span><span class="text-emerald-400">${ssrInterpolate(unref(fmt).rupiah((_s = unref(payModal).inv) == null ? void 0 : _s.paid_amount))}</span></div><div class="h-px bg-navy-700 my-1"></div><div class="flex justify-between text-xs font-semibold"><span class="text-gray-400">Sisa Tagihan</span><span class="text-orange-400">${ssrInterpolate(unref(fmt).rupiah((((_t = unref(payModal).inv) == null ? void 0 : _t.invoice_amount) || 0) - (((_u = unref(payModal).inv) == null ? void 0 : _u.paid_amount) || 0)))}</span></div></div><div class="space-y-3"><div><label class="form-label">Jumlah Bayar (Rp)</label>`);
      ...
      if (unref(showEditForm)) {
        ...
        ssrRenderList(((_v = unref(data)) == null ? void 0 : _v.rev_projects) || [], (p) => {
      ...
      if (unref(deleteModal).show) {
        _push(`<div class="fixed inset-0 bg-black/70 z-50 flex items-center justify-center p-4"><div class="bg-navy-900 border border-red-800/50 rounded-xl w-full max-w-sm shadow-2xl p-5"><div class="flex items-center gap-3 mb-4"><div class="w-10 h-10 rounded-full bg-red-900/40 flex items-center justify-center flex-shrink-0"><i class="fa-solid fa-triangle-exclamation text-red-400 text-lg"></i></div><div><h3 class="font-semibold text-white">Hapus Invoice</h3><p class="text-xs text-gray-400">Tindakan ini tidak dapat dibatalkan.</p></div></div><div class="bg-navy-800 rounded-lg p-3 mb-4 space-y-1.5 text-xs"><div class="flex justify-between"><span class="text-gray-500">No. Invoice</span><span class="text-white font-medium">${ssrInterpolate(((_w = unref(deleteModal).inv) == null ? void 0 : _w.invoice_no) || "\u2014")}</span></div><div class="flex justify-between"><span class="text-gray-500">Client</span><span class="text-gray-200">${ssrInterpolate((_x = unref(deleteModal).inv) == null ? void 0 : _x.client)}</span></div><div class="flex justify-between"><span class="text-gray-500">Nominal</span><span class="text-gray-200">${ssrInterpolate(unref(fmt).rupiah((_y = unref(deleteModal).inv) == null ? void 0 : _y.invoice_amount))}</span></div><div class="flex justify-between"><span class="text-gray-500">Status</span><span class="${ssrRenderClass(((_z = unref(deleteModal).inv) == null ? void 0 : _z.display_status) === "Lunas" ? "text-emerald-400" : ((_A = unref(deleteModal).inv) == null ? void 0 : _A.display_status) === "Partial" ? "text-yellow-400" : "text-red-400")}">${ssrInterpolate((_B = unref(deleteModal).inv) == null ? void 0 : _B.display_status)}</span></div></div>`);
      ...
      if (unref(showForm)) {
        ...
        ssrRenderList(((_C = unref(data)) == null ? void 0 : _C.rev_projects) || [], (p) => {
...
//# sourceMappingURL=invoice-BdX6OJMp.mjs.map
